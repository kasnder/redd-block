...
inside `Rum.app/Contents/PlugIns/`. Installing Rum on
...
binary lives inside `Rum.app/Contents/MacOS/` and
...
- **`/Applications/Rum.app` was hand-modified during the
