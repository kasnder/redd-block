...
Write-Host "=== Building MSIX Package (Rum) ===" -ForegroundColor Cyan
Write-Host ""
...
if (-not $IdentityName -or -not $Publisher) {
    ...
    Write-Host "  Find these under Partner Center -> Apps and games -> Rum -> Product identity" -ForegroundColor Yellow
    exit 1
}
...
Write-Host "  App: Rum v$AppVersion" -ForegroundColor White
