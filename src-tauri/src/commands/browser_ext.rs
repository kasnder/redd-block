...
/// Visible compact warning chrome without activating Rum as the key
...
///   front without making Rum the active app, so the user can keep
...
<body>
  <div class="card">
    ...
    <p>Use the main Rum warning and click <strong>Let's go!</strong> to start your wrap-up time.</p>
  </div>
</body>
</html>"#
}
