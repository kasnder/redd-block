...
import { AUTOMATION_BROWSER_KEYS, BROWSER_STORE_LINKS, MAC_BLOCKING_METHOD_KEYS, bannerHeadlineKey, browserBlockingMethod, browserIconUrl, browserUsesAutomation, ensureSafariExtensionFdaBeforeSetup, invalidateMigrationMacCopyCache, lastAutomationPermissionByKey, lastOnboardingState, migrationExtLinesHtml, openExtensionSetupOverlay, refreshAutomationPermissionStatus, refreshBehaviourBannerIfStale, renderBrowserInstallButtons, safariUsesExtensionMode, setupAppForegroundRefresh, setupEnforcerUiAlerts, setupSettingsEnforcementSection, setupWebAutomationUiAlerts, startMigrationPolling, startWebAutomationWatcher, stopMigrationPolling, syncBlockingMethodLabelIcons, syncMigrationMacHowto, syncMigrationPostHeader, syncSafariFdaOnboardingGrantButton, updateAllEnforcementToggleLocks, updateBehaviourChangeBanner, updateGraceSettingLock, wireEnforcementToggle } from './enforcement.js';
import {
