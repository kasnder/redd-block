...
export const SETTINGS_TRANSLATIONS = {
    en: {
        ...
        allowlistModeHint: 'If no websites are on the list, all are allowed — the same goes for apps.',
    ...
    da: {
        ...
        welcomeStep1BodyAutomationHtml:
            'I Safari, Chrome, Brave og Edge bruger <em>ReDD Blocker</em> Automatisering til at blokere hjemmesider. Vi beder dig om at tillade adgang.',
        ...
        welcomeStep2BodyIosHtml:
            '<em>ReDD Blocker</em> bruger Screen Time til at skærme apps og hjemmesider på iPhone og iPad. Vi beder om tilladelse før din første blokering.',
        welcomeStep2TitleAndroidHtml: 'Slå Android Accessibility-blokering til',
        welcomeStep2BodyAndroidHtml:
            '<em>ReDD Blocker</em> bruger Android Accessibility til at registrere blokerede apps og hjemmesider og vise blokeringsskærmen. Vi åbner Android-indstillinger, så du kan slå det til.',
        welcomeStep3TitleHtml: 'Vælg, hvad der skal blokeres',
        welcomeStep3BodyHtml:
            'Vælg de hjemmesider og apps, der distraherer dig, og bestem hvornår de skal være utilgængelige. <em>ReDD Blocker</em> klarer resten.',
        ...
        migrationPreExplainerHtml: 'ReDD Blocker blokerer nu hjemmesider via en browserudvidelse i stedet for et systemværktøj.<br>Vi skal:',
        ...
        webAutomationBannerBody: 'ReDD Blocker skal have tilladelse til at styre {browsers} for at blokere hjemmesider. Slå det til under Anonymitet & sikkerhed → Automatisering, så træder blokeringen i kraft.',
        ...
        allowlistModeHint: 'Hvis listen ikke har nogen hjemmesider, er alle tilladt — det samme gælder for apps.',
        ...
        helperSetupText: 'For at blokere hjemmesider, når appen er lukket, skal ReDD Blocker installere en lille baggrundstjeneste. Din computer beder om adgangskode én gang — derefter starter blokeringer med det samme uden ny prompt.',
        ...
        helperHint: 'Fjern alle ReDD Blocker-indsætninger fra systemets hosts-fil. Brug kun dette, hvis hjemmesider stadig er utilgængelige efter du har stoppet alle blokeringer.',
        close: 'Luk',
        // Time/date words
    ...
    'zh-CN': {
        ...
        welcomeOnboardingSubtitle: '为平静专注留出空间，\n阻止让你分心的应用和网站。',
        welcomeHowHeading: '开始步骤（我们会一步步引导你）',
        welcomeStep1TitleAutomationHtml: '允许 {APPLE}自动化',
        welcomeStep1BodyAutomationHtml: '在 Safari、Chrome、Brave 和 Edge 中，<em>ReDD Blocker</em> 使用自动化来阻止网站。我们会提示你允许访问。',
        ...
        welcomeStep2BodyIosHtml: '在 iPhone 和 iPad 上，<em>ReDD Blocker</em> 使用屏幕时间来屏蔽应用和网站。首次阻止前我们会请求权限。',
        welcomeStep2TitleAndroidHtml: '启用 Android 无障碍阻止',
        welcomeStep2BodyAndroidHtml: '<em>ReDD Blocker</em> 使用 Android 无障碍功能来检测被阻止的应用和网站并显示阻止界面。我们会打开 Android 设置以便你启用它。',
        welcomeStep3TitleHtml: '开始阻止吧！🥳',
        welcomeStep3BodyHtml: '选择让你分心的网站和应用，并设置你希望它们不可访问的时间。剩下的交给 <em>ReDD Blocker</em>。',
        ...
        migrationPreWarnHtml: '你会看到<strong>一次</strong>管理员密码提示。切换期间阻止会短暂停止。清理完成后，ReDD Blocker 会自动为你的浏览器设置 <strong>ReDD Focus</strong> 扩展，你只需允许它在隐私/无痕窗口中运行。',
        ...
        migrationExtStep1Mac: '点击下方每个浏览器的<strong>授予访问权限</strong>，并批准 macOS 权限提示。如果看到<strong>打开自动化设置</strong>，请点击并重新开启 ReDD Blocker。',
        ...
        importBlocklistsInvalidFile: '请选择有效的 ReDD Blocker 专注空间文件。',
        ...
        websitesAllowTooltip: '只有你添加的域名会在此专注空间期间保持可访问。其他网站将被阻止。',
        apps: '要阻止的应用',
        appsAllow: '允许使用的应用',
        appsTooltip: '请输入应用的准确名称（例如“Safari”）。也可以使用文件夹按钮查找应用。',
        appsAllowTooltip: '只有你添加的应用会在此专注空间期间保持可用。在支持的平台上，其他应用将被阻止。',
        blocklistModeHint: '列表中的网站和应用将被阻止 — 其他一切照常可用。',
        allowlistModeHint: '如果列表中没有网站，则全部允许 — 应用也是如此。',
        ...
        allowlistIosCategoriesIgnored: 'iOS 无法允许屏幕使用时间类别。ReDD Blocker 会忽略类别选择，仅允许你选择的具体应用。继续吗？',
        ...
        uninstallConfirmLeadHtml: 'ReDD Blocker 会被移到废纸篓。你的专注空间和日程会<strong>保留在磁盘上</strong>，以后重新安装时可以恢复。',
        uninstallConfirmLeadDeleteHtml: 'ReDD Blocker 会被移到废纸篓。你的专注空间、日程和设置会从这台 Mac 上<strong>永久删除</strong>。',
