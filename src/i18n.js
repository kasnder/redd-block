...
export const SETTINGS_TRANSLATIONS = {
    en: {
        ...
        // Shown in the edit modal only when the pending change would make a
        // running focus space easier to get around; saving it needs the challenge.
        blocklistLoosenHintFmt: 'This space is running. {reason} — you\'ll need to type the exit challenge to save.',
        blocklistLoosenReasonRemoved: 'You removed items from the list',
        blocklistLoosenReasonAllowedMore: 'You allowed more than before',
        blocklistLoosenReasonAllowAllWeb: 'An empty allow list lets every website through',
        blocklistLoosenReasonAllowAllApps: 'An empty allow list lets every app through',
        blocklistLoosenReasonScreenTime: 'You changed the Screen Time selection',
        blocklistLoosenReasonDifficulty: 'You changed the exit difficulty',
        blocklistLoosenReasonMode: 'You changed the list mode',
        /** Word-by-word challenge counter (mobile). */
        challengeWordProgressFmt: 'Word {current} of {total}',
        unlockEditsTitle: 'Save changes to a running space?',
        unlockEditsSubtitleFmt: 'These changes make <strong>{name}</strong> less strict.',
        unlockEditsInstruction: 'To save this change while the space is running, type the following:',
        unlockEditsConfirmBtn: 'Save changes',
        name: 'Name',
    ...
    da: {
        ...
        blocklistLoosenHintFmt: 'Dette rum kører. {reason} — du skal skrive udfordringsteksten for at gemme.',
        blocklistLoosenReasonRemoved: 'Du fjernede emner fra listen',
        blocklistLoosenReasonAllowedMore: 'Du tillod mere end før',
        blocklistLoosenReasonAllowAllWeb: 'En tom tilladelsesliste lukker alle hjemmesider igennem',
        blocklistLoosenReasonAllowAllApps: 'En tom tilladelsesliste lukker alle apps igennem',
        blocklistLoosenReasonScreenTime: 'Du ændrede Skærmtid-udvalget',
        blocklistLoosenReasonDifficulty: 'Du ændrede sværhedsgraden for at afslutte',
        blocklistLoosenReasonMode: 'Du ændrede listetilstanden',
        challengeWordProgressFmt: 'Ord {current} af {total}',
        unlockEditsTitle: 'Gem ændringer i et kørende rum?',
        unlockEditsSubtitleFmt: 'Disse ændringer gør <strong>{name}</strong> mindre streng.',
        unlockEditsInstruction: 'For at gemme denne ændring mens rummet kører, skriv følgende:',
        unlockEditsConfirmBtn: 'Gem ændringer',
        name: 'Navn',
    ...
    'zh-CN': {
        ...
        blocklistLoosenHintFmt: '该专注空间正在运行。{reason}——需要输入退出挑战文本才能保存。',
        blocklistLoosenReasonRemoved: '你从列表中移除了项目',
        blocklistLoosenReasonAllowedMore: '你允许的内容比之前更多',
        blocklistLoosenReasonAllowAllWeb: '空的允许列表会放行所有网站',
        blocklistLoosenReasonAllowAllApps: '空的允许列表会放行所有应用',
        blocklistLoosenReasonScreenTime: '你更改了屏幕使用时间的选择',
        blocklistLoosenReasonDifficulty: '你更改了退出难度',
        blocklistLoosenReasonMode: '你更改了列表模式',
        challengeWordProgressFmt: '第 {current} 个词，共 {total} 个',
        unlockEditsTitle: '保存对正在运行的专注空间的更改？',
        unlockEditsSubtitleFmt: '这些更改会让 <strong>{name}</strong> 的限制变宽松。',
        unlockEditsInstruction: '要在专注空间运行时保存此更改，请输入以下内容：',
        unlockEditsConfirmBtn: '保存更改',
        name: '名称',
