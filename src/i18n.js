...
export const SETTINGS_TRANSLATIONS = {
    en: {
        ...
        addFocusSpaceBtn: 'New space',
        quickStartBtn: 'Quick start',
        blocklistsCreateActionsAria: 'Create focus space',
        ...
        migrationPreWarnHtml: 'You\'ll see <strong>one</strong> admin password prompt. Blocking will pause briefly during the changeover. After cleanup, Digital Habits: Blocker sets up the <strong>ReDD Focus</strong> browser extension in your browsers automatically — you just need to allow it in private/incognito tabs.',
        ...
        migrationHowtoLi1Html: 'Digital Habits: Blocker has tried to install ReDD Focus in your browsers. If it shows as not installed below, click the <strong>Install</strong> buttons to add it manually.',
        ...
        migrationSafariDuplicateIntroHtml: 'You have <strong>ReDD Focus: Hide Distractions</strong> from the App Store <em>and</em> the copy that ships inside Digital Habits: Blocker. They conflict — keep only one.',
        migrationSafariDuplicateInstructionsHeading: 'In Safari → Settings → Extensions',
        migrationSafariDuplicateStep1Html: 'Find <strong>ReDD Focus: Hide Distractions</strong> — the App Store copy (not “via Digital Habits: Blocker”) — and uncheck <span class="safari-duplicate-checkbox" role="img" aria-label="Unchecked"></span> it.',
        migrationSafariDuplicateStep2Html: 'Make sure <span class="safari-duplicate-checkbox safari-duplicate-checkbox-checked" role="img" aria-label="Checked"></span> is checked for <strong>ReDD Focus (via Digital Habits: Blocker)</strong>. That\'s the one this app controls.',
        migrationSafariDuplicateOpenBtn: 'Open Safari Extensions…',
        migrationSafariDuplicateHelpLink: 'How did this happen?',
        migrationSafariDuplicateHelpText: 'If you previously installed ReDD Focus from the App Store and later installed Digital Habits: Blocker, Safari keeps both extensions registered. Digital Habits: Blocker only works with the bundled copy.',
        ...
        safariFdaOnboardingWhyHtml: 'Blocking on Safari through the ReDD Focus browser extension requires Full Disk Access to ensure the extension is installed, enabled, and allowed in private browsing. Open System Settings below, then toggle <strong>Digital Habits: Blocker</strong> on (use + if it is not listed).',
        ...
        migrationFirefoxNativeHostHtml: 'ReDD Focus is installed. Digital Habits: Blocker still needs to register its connection with Firefox (one small setup step).',
        ...
        migrationPostInstallFirefoxHtml: 'Digital Habits: Blocker already set up auto-install for ReDD Focus in Firefox — <strong>restart Firefox</strong> to pick it up. (Or click <strong>Install</strong> below to add it manually — check <strong>Allow extension to run in private windows</strong> during install.)',
        ...
        migrationPostInstallChromiumHtml: 'Digital Habits: Blocker already set up auto-install for ReDD Focus in {BROWSER} — <strong>restart {BROWSER}</strong> to pick it up. (Or click <strong>Install</strong> below to add it manually now.)',
        ...
        enforcerCountdownInstrAccess: 'Digital Habits: Blocker can’t verify ReDD Focus. Grant access to stop the countdown.',
        ...
        enforcerHeadlineAccess: 'Digital Habits: Blocker can’t verify ReDD Focus in {browser}.',
        ...
        enforcerClosedAccess: '{browser} was closed so your protection could stay clear—Digital Habits: Blocker couldn’t verify ReDD Focus.',
        ...
        enforcerClosedCombinedAccess: '{browser} were closed so your protection could stay clear—Digital Habits: Blocker couldn’t verify ReDD Focus.',
    ...
    da: {
        ...
        addFocusSpaceBtn: 'Nyt rum',
        quickStartBtn: 'Kvikstart',
        blocklistsCreateActionsAria: 'Opret fokusrum',
        ...
        welcomeOnboardingSubtitle:
            'Blokér distraherende apps og hjemmesider, og skab plads og ro til fokus.',
        ...
        welcomeStep2BodyHtml:
            'Vores {LOGO}<strong>ReDD Focus</strong>-udvidelse er det, der faktisk blokerer hjemmesider. Vi installerer den automatisk i dine browsere, hvor vi kan, og viser dig, hvad du skal gøre.',
        ...
        migrationPreWarnHtml: 'Du vil få <strong>én</strong> prompt om administratoradgang. Under skiftet sættes blokering kortvarigt på pause. Efter oprydningen sætter Digital Habits: Blocker <strong>ReDD Focus</strong> op i dine browsere automatisk — du skal bare tillade den i private/inkognitofaner.',
        ...
        migrationHowtoLi1Html: 'Digital Habits: Blocker har forsøgt at installere ReDD Focus i dine browsere. Hvis den vises som ikke installeret nedenfor, klik på <strong>Installer</strong>-knapperne for at tilføje den manuelt.',
        ...
        migrationSafariDuplicateIntroHtml: 'Du har <strong>ReDD Focus: Hide Distractions</strong> fra App Store <em>og</em> kopien, der følger med Digital Habits: Blocker. De kan ikke begge være aktive — behold kun én.',
        migrationSafariDuplicateInstructionsHeading: 'I Safari → Indstillinger → Udvidelser',
        migrationSafariDuplicateStep1Html: 'Find <strong>ReDD Focus: Hide Distractions</strong> — App Store-kopien (ikke “via Digital Habits: Blocker”) — og fjern markeringen <span class="safari-duplicate-checkbox" role="img" aria-label="Ikke markeret"></span>.',
        migrationSafariDuplicateStep2Html: 'Sørg for, at afkrydsningsfeltet <span class="safari-duplicate-checkbox safari-duplicate-checkbox-checked" role="img" aria-label="Markeret"></span> er markeret for <strong>ReDD Focus (via Digital Habits: Blocker)</strong>. Det er den, denne app styrer.',
        migrationSafariDuplicateOpenBtn: 'Åbn Safari-udvidelser…',
        migrationSafariDuplicateHelpLink: 'Hvordan skete det?',
        migrationSafariDuplicateHelpText: 'Hvis du tidligere installerede ReDD Focus fra App Store og senere installerede Digital Habits: Blocker, beholder Safari begge udvidelser. Digital Habits: Blocker virker kun med den bundtede kopi.',
        ...
        migrationFirefoxNativeHostHtml: 'ReDD Focus er installeret. Digital Habits: Blocker skal stadig registrere forbindelsen til Firefox (ét lille trin).',
        ...
        migrationPostInstallFirefoxHtml: 'Digital Habits: Blocker har allerede sat auto-installation op for ReDD Focus i Firefox — <strong>genstart Firefox</strong> for at hente den ind. (Eller klik på <strong>Installer</strong> nedenfor for at tilføje den manuelt — markér <strong>Allow extension to run in private windows</strong> under installationen.)',
        ...
        migrationPostInstallChromiumHtml: 'Digital Habits: Blocker har allerede sat auto-installation op for ReDD Focus i {BROWSER} — <strong>genstart {BROWSER}</strong> for at hente den ind. (Eller klik på <strong>Installer</strong> nedenfor for at tilføje den manuelt nu.)',
        ...
        migrationInstructionWebsiteAccessHtml: 'Åbn dine udvidelsesindstillinger (kopier {URL_CHIP}, og indsæt den i adresselinjen i {BROWSER}) → klik på <strong>Details</strong> ved ReDD Focus → tillad på <strong>alle hjemmesider</strong>.',
        ...
        migrationHintWebsitesSafariMulti: 'Tillad ReDD Focus på alle hjemmesider for hver Safari-profil.{SUFFIX}',
        migrationHintWebsitesSafariOne: 'Tillad ReDD Focus på alle hjemmesider i Safaris udvidelsesindstillinger.',
        ...
        migrationShotSafariCap2: 'Derefter: i) aktivér ReDD Focus, ii) tillad privat browsing, iii) tillad blokering på alle hjemmesider',
        ...
        enforcerCountdownInstrWebsiteAccess: 'ReDD Focus er ikke tilladt på alle hjemmesider. Tillad alle hjemmesider for at stoppe nedtællingen.',
        enforcerCountdownInstrAccess: 'Digital Habits: Blocker kan ikke bekræfte ReDD Focus. Giv adgang for at stoppe nedtællingen.',
        ...
        enforcerCountdownWebsiteAccess: '{browser} lukkes automatisk hvis ReDD Focus ikke er tilladt på alle hjemmesider, for at understøtte din blokering.',
        ...
        enforcerHeadlineWebsiteAccess: '{browser} har ikke givet ReDD Focus adgang på alle hjemmesider endnu.',
        enforcerInstrWebsiteAccessPlain: 'I {browser}s udvidelsesindstillinger: tillad ReDD Focus på alle hjemmesider.',
        enforcerHeadlineAccess: 'Digital Habits: Blocker kan ikke bekræfte ReDD Focus i {browser}.',
        ...
        enforcerClosedWebsiteAccess: '{browser} blev lukket for at bakke din blok op—ReDD Focus kunne ikke dække alle hjemmesider endnu.',
        enforcerClosedAccess: '{browser} blev lukket, så din beskyttelse kunne være tydelig—Digital Habits: Blocker kunne ikke bekræfte ReDD Focus.',
        ...
        enforcerClosedCombinedWebsiteAccess: '{browser} blev lukket for at bakke din blok op—ReDD Focus kunne ikke dække alle hjemmesider endnu.',
        enforcerClosedCombinedAccess: '{browser} blev lukket, så din beskyttelse kunne være tydelig—Digital Habits: Blocker kunne ikke bekræfte ReDD Focus.',
        ...
        enforcerClosedInstrWebsiteAccess: 'I {browser}s udvidelsesindstillinger: tillad ReDD Focus på alle hjemmesider.',
        ...
        settingsBlockingMethodHint: 'Om hjemmesideblokering skal bruge Automatisering eller ReDD Focus-browserudvidelsen (prøv sidstnævnte hvis blokering er forsinket).',
        ...
        exportBlocklistsSuccessFmt: 'Eksporterede {n} blokliste(r) og deres tidsplaner til {path}.',
        ...
        scheduleStrictnessLabel: 'Strenghed',
        allowEditsFlexibleLabel: 'Fleksibel',
        allowEditsFlexibleDesc: 'Du kan redigere eller pause dette skema, når det ikke blokerer aktivt.',
        allowEditsStrictLabel: 'Forpligtet',
        allowEditsStrictDesc: 'Når det er startet, kan du kun gøre skemaet strammere, indtil du stopper det helt.',
        allowEditsBetweenBlocksLockedTooltip: 'Stop skemaet helt for at ændre denne indstilling. Pause er ikke nok.',
        ...
        quickStartTitle: 'Hurtig start',
        quickStartDefaultName: 'Hurtig start',
        quickStartEffortLabel: 'Indsats for at stoppe',
        ...
        blocklistModeSentenceBefore: 'Når denne liste er aktiv,',
        blocklistModeSentenceAfter: 'dens hjemmesider og apps.',
        ...
        blocklistModeHint: 'Hjemmesiderne og appsene på din liste bliver blokeret — alt andet fungerer som normalt.',
        ...
        overrideAllWarningBody: 'Dette stopper ALLE nuværende blokeringer af hjemmesider og apps. Det stopper også alle skemalagte blokeringer.',
        ...
        uninstallConfirmLeadHtml: 'Digital Habits: Blocker flyttes til papirkurven. Dine blokeringslister og skemaer <strong>bevares p\u00e5 harddisken</strong>, s\u00e5 de kan gendannes, hvis du geninstallerer senere.',
        uninstallConfirmLeadDeleteHtml: 'Digital Habits: Blocker flyttes til papirkurven. Dine blokeringslister, skemaer og indstillinger bliver <strong>permanent slettet</strong> fra denne Mac.',
        ...
        uninstallFirefoxCalloutDetailHtml: 'Du kan forts\u00e6tte med at bruge ReDD Focus til at skjule distraherende dele af hjemmesider. For at fjerne den, \u00e5bn Firefox\u2019 udvidelsesindstillinger \u2014 kopier {URL_CHIP} og inds\u00e6t den i adresselinjen.',
    ...
    'zh-CN': {
        ...
        quickStartBtn: '快速开始',
        blocklistsCreateActionsAria: '创建专注空间',
        ...
        welcomeStep2BodyFirefoxHtml: 'Firefox 阻止功能使用我们的 <strong>ReDD Focus</strong> 扩展。我们会引导你从 Firefox 附加组件商店安装。',
        welcomeStep2TitleHtml: '在浏览器中启用阻止，并允许在隐私/无痕窗口中运行',
        welcomeStep2BodyHtml: '{LOGO}<strong>ReDD Focus</strong> 扩展负责真正阻止网站。能自动安装的浏览器我们会自动处理，并告诉你需要手动完成的步骤。',
        ...
        migrationPreWarnHtml: '你会看到<strong>一次</strong>管理员密码提示。切换期间阻止会短暂停止。清理完成后，Digital Habits: Blocker 会自动为你的浏览器设置 <strong>ReDD Focus</strong> 扩展，你只需允许它在隐私/无痕窗口中运行。',
        ...
        migrationExtStep2MacFirefox: 'Firefox：点击下方<strong>安装</strong>，从附加组件商店添加 {FOCUS}<strong>ReDD Focus</strong>，然后允许它在隐私窗口中运行。',
        migrationHowtoHeading: '设置',
        migrationHowtoLi1Html: 'Digital Habits: Blocker 已尝试在你的浏览器中安装 ReDD Focus。如果下方显示未安装，请点击<strong>安装</strong>按钮手动添加。',
        ...
        migrationSafariDuplicateIntroHtml: '你同时安装了来自 App Store 的 <strong>ReDD Focus: Hide Distractions</strong> 和 Digital Habits: Blocker 内置副本。两者会冲突，请只保留一个。',
        migrationSafariDuplicateInstructionsHeading: '在 Safari → 设置 → 扩展中',
        migrationSafariDuplicateStep1Html: '找到 <strong>ReDD Focus: Hide Distractions</strong> 这个 App Store 副本（不是“via Digital Habits: Blocker”），取消勾选 <span class="safari-duplicate-checkbox" role="img" aria-label="未勾选"></span>。',
        migrationSafariDuplicateStep2Html: '确保 <span class="safari-duplicate-checkbox safari-duplicate-checkbox-checked" role="img" aria-label="已勾选"></span> 已为 <strong>ReDD Focus (via Digital Habits: Blocker)</strong> 勾选。这是本应用控制的版本。',
        migrationSafariDuplicateOpenBtn: '打开 Safari 扩展...',
        migrationSafariDuplicateHelpLink: '这是怎么发生的？',
        migrationSafariDuplicateHelpText: '如果你以前从 App Store 安装过 ReDD Focus，之后又安装 Digital Habits: Blocker，Safari 会保留两个扩展。Digital Habits: Blocker 只能使用内置副本。',
        ...
        safariFdaOnboardingWhyHtml: '通过 ReDD Focus 浏览器扩展在 Safari 中阻止网站时，需要完全磁盘访问权限，才能确认扩展已安装、启用并允许隐私浏览。请打开下方系统设置，然后开启 <strong>Digital Habits: Blocker</strong>（如果列表中没有，请使用 + 添加）。',
        ...
        migrationFirefoxNativeHostHtml: 'ReDD Focus 已安装。Digital Habits: Blocker 还需要注册与 Firefox 的连接（一个小设置步骤）。',
        ...
        migrationPostInstallFirefoxHtml: 'Digital Habits: Blocker 已为 Firefox 设置自动安装 ReDD Focus。请<strong>重启 Firefox</strong> 以生效。（也可以点击下方<strong>安装</strong>手动添加，并在安装时勾选允许扩展在隐私窗口中运行。）',
        ...
        migrationPostInstallChromiumHtml: 'Digital Habits: Blocker 已为 {BROWSER} 设置自动安装 ReDD Focus。请<strong>重启 {BROWSER}</strong> 以生效。（也可以点击下方<strong>安装</strong>手动添加。）',
        ...
        enforcerCountdownDefault: '如果 ReDD Focus 未就绪，{browser} 将被自动关闭，以支持你的阻止。',
        enforcerCountdownMissing: '如果未安装 ReDD Focus，{browser} 将被自动关闭，以支持你的阻止。',
        enforcerCountdownDisabled: '如果 ReDD Focus 未启用，{browser} 将被自动关闭，以支持你的阻止。',
        enforcerCountdownPrivate: '如果 ReDD Focus 未在隐私窗口中启用，{browser} 将被自动关闭，以支持你的阻止。',
        enforcerCountdownWebsiteAccess: '如果 ReDD Focus 无法访问所有网站，{browser} 将被自动关闭，以支持你的阻止。',
        enforcerCountdownAccess: '如果无法确认 ReDD Focus，{browser} 将被自动关闭，以支持你的阻止。',
        ...
        settingsBlockingMethodEdge: 'Edge',
        settingsBlockingMethodSafari: 'Safari',
        settingsEnforcementRowLabel: '保护停止时自动关闭浏览器',
