...
export const SETTINGS_TRANSLATIONS = {
    en: {
        ...
        allowEditsHeading: 'Editing while the schedule runs',
        allowEditsFlexibleLabel: 'Flexible',
        allowEditsFlexibleDesc: 'When the schedule isn\'t actively blocking, you can edit or pause it however you like.',
        allowEditsStrictLabel: 'Committed',
        allowEditsStrictDesc: 'Until you fully stop the schedule, the only changes you can make are ones that make it more restrictive.',
        allowEditsBetweenBlocksLockedTooltip: 'Stop the schedule completely to change this setting. Pausing is not enough.',
        pauseDifficultyLiftedByAllowEdits: 'Pause difficulty lifted by “Allow edits between blocks” being on.',
    ...
    da: {
        ...
        allowEditsHeading: 'Redigering mens skemaet kører',
        allowEditsFlexibleLabel: 'Fleksibel',
        allowEditsFlexibleDesc: 'Når skemaet ikke blokerer aktivt, kan du redigere eller pause det, som du vil.',
        allowEditsStrictLabel: 'Forpligtet',
        allowEditsStrictDesc: 'Indtil du stopper skemaet helt, kan du kun lave ændringer, der gør det mere restriktivt.',
        allowEditsBetweenBlocksLockedTooltip: 'Stop skemaet helt for at ændre denne indstilling. Pause er ikke nok.',
        pauseDifficultyLiftedByAllowEdits: 'Pause-sværhedsgrad ophævet, fordi “Tillad redigering mellem blokeringer” er slået til.',
        ...
        quickStartNeedItems: 'Tilføj mindst ét website eller en app for at starte.',
    ...
    'zh-CN': {
        ...
        allowEditsHeading: '日程运行期间的编辑',
        allowEditsFlexibleLabel: '灵活',
        allowEditsFlexibleDesc: '日程未实际阻止时，你可以随意编辑或暂停它。',
        allowEditsStrictLabel: '坚定',
        allowEditsStrictDesc: '在完全停止日程之前，你只能进行让它更严格的更改。',
        allowEditsBetweenBlocksLockedTooltip: '需完全停止日程后才能更改此设置。暂停不够。',
        pauseDifficultyLiftedByAllowEdits: '暂停难度已解除，因为已开启“允许在阻止之间编辑”。',
        ...
        blocklistModeHint: '你添加的网站和应用将被阻止。',
        allowlistModeHint: '只有你添加的网站和应用会在此专注空间期间保持可用。',
