...
export const SETTINGS_TRANSLATIONS = {
    en: {
        ...
        migrationSafariDuplicateIntroHtml: 'You have <strong>Digital Habits: Focus: Hide Distractions</strong> from the App Store <em>and</em> the copy that ships inside Digital Habits: Blocker. They conflict — keep only one.',
        migrationSafariDuplicateInstructionsHeading: 'In Safari → Settings → Extensions',
        migrationSafariDuplicateStep1Html: 'Find <strong>Digital Habits: Focus: Hide Distractions</strong> — the App Store copy (not “via Digital Habits: Blocker”) — and uncheck <span class="safari-duplicate-checkbox" role="img" aria-label="Unchecked"></span> it.',
    ...
    da: {
        ...
        migrationSafariDuplicateIntroHtml: 'Du har <strong>Digital Habits: Focus: Hide Distractions</strong> fra App Store <em>og</em> kopien, der følger med Digital Habits: Blocker. De kan ikke begge være aktive — behold kun én.',
        migrationSafariDuplicateInstructionsHeading: 'I Safari → Indstillinger → Udvidelser',
        migrationSafariDuplicateStep1Html: 'Find <strong>Digital Habits: Focus: Hide Distractions</strong> — App Store-kopien (ikke “via Digital Habits: Blocker”) — og fjern markeringen <span class="safari-duplicate-checkbox" role="img" aria-label="Ikke markeret"></span>.',
    ...
    'zh-CN': {
        ...
        migrationSafariDuplicateIntroHtml: '你同时安装了来自 App Store 的 <strong>Digital Habits: Focus: Hide Distractions</strong> 和 Digital Habits: Blocker 内置副本。两者会冲突，请只保留一个。',
        migrationSafariDuplicateInstructionsHeading: '在 Safari → 设置 → 扩展中',
        migrationSafariDuplicateStep1Html: '找到 <strong>Digital Habits: Focus: Hide Distractions</strong> 这个 App Store 副本（不是“via Digital Habits: Blocker”），取消勾选 <span class="safari-duplicate-checkbox" role="img" aria-label="未勾选"></span>。',
