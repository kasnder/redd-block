...
export const SETTINGS_TRANSLATIONS = {
    en: {
        ...
        allowEditsBetweenBlocksLabel: 'Allow edits between blocks',
        allowEditsBetweenBlocksHint: 'If you turn this on, you can pause or change this schedule when it is not actively blocking.',
    ...
    da: {
        ...
        allowEditsBetweenBlocksLabel: 'Tillad redigering mellem blokeringer',
        allowEditsBetweenBlocksHint: 'Hvis du slår dette til, kan du sætte tidsplanen på pause eller ændre den, når den ikke blokerer aktivt.',
    ...
    'zh-CN': {
        ...
        allowEditsBetweenBlocksLabel: '允许在阻止之间编辑',
        allowEditsBetweenBlocksHint: '开启后，可在日程未实际阻止时暂停或更改该日程。',
